 ...
 */
public class DS18x20Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(getArguments() != null &&getArguments().containsKey("useLargeLayout") && getArguments().getBoolean("useLargeLayout")) {
            ...
            return inflater.inflate(R.layout.fragment_ds18x20_large, container, false);
        }
        return inflater.inflate(R.layout.fragment_ds18x20_small, container, false);
    }
