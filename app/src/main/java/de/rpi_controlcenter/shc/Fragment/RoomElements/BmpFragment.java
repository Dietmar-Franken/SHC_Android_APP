...
public class BmpFragment extends Fragment {
    ...
    public final int PRESS_TEXT_VIEW = (new Double(Math.random() * 1000)).intValue();
    public final int ALTI_TEXT_VIEW = (new Double(Math.random() * 1000)).intValue();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(getArguments() != null &&getArguments().containsKey("useLargeLayout") && getArguments().getBoolean("useLargeLayout")) {
            ...
            return inflater.inflate(R.layout.fragment_bmp_large, container, false);
        }
        return inflater.inflate(R.layout.fragment_bmp_small, container, false);
    }
    ...
    public void onStart() {
        ...
        if(getActivity().findViewById(R.id.element_name) != null) {
            ...
            pressView = (TextView) getActivity().findViewById(R.id.element_press);
            pressView.setId(PRESS_TEXT_VIEW);
            altiView = (TextView) getActivity().findViewById(R.id.element_alti);
    ...
    public void updateData() {
        ...
        final String press = args.getString("press");
        final String alti = args.getString("alti");

        tempView.setText(temp);
        pressView.setText(press);
        altiView.setText(alti);
    }
